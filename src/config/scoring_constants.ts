...
export const SCORE_BANDS = [
  ...
  { min: 70, label: "ORANGE", bg: "#ffa500", text: "text-gray-900", category: "needs attention" },
  { min: 80, label: "BLUE", bg: "#0000ff", text: "text-white", category: "needs attention" },
  { min: 90, label: "PURPLE", bg: "#800080", text: "text-white", category: "needs attention" },
  { min: 98, label: "BROWN", bg: "#8B4513", text: "text-white", category: "needs support" },
  { min: 99, label: "BLACK", bg: "#000000", text: "text-white", category: "needs support" },
